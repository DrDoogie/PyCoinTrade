        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            ...
            if target_price < current_price:
                if krw*0.3 > 5000:
                    ...
                    post_message(myToken, "#cointrade", "BTC buy : " + str(buy_result)+str(now))
                  # 수익 전환
            elif buy_result != 0 and buy_result * 1.05 < current_price and earn *0.9 >0.0001:
                success1_result = upbit.sell_market_order("KRW-BTC", earn * 0.50)
                post_message(myToken, "#cointrade", "BTC 5Pro sell : " + str(success1_result))
            elif buy_result != 0 and buy_result * 1.03 < current_price and earn *0.5 >0.0001:
                success2_result = upbit.sell_market_order("KRW-BTC", earn * 0.50)
                post_message(myToken, "#cointrade", "BTC 3pro sell : " + str(success2_result))
            elif start_time + datetime.timedelta(hours=6) < now and buy_result != 0 and buy_result * 1.02 < current_price and earn *0.5 >0.0001:
                success3_result = upbit.sell_market_order("KRW-BTC", earn * 0.50)
                post_message(myToken, "#cointrade", "BTC 2pro sell : " + str(success3_result))
            elif start_time + datetime.timedelta(hours=10) < now and buy_result != 0 and buy_result * 1.015 < current_price and earn *0.5 >0.0001:
                success4_result = upbit.sell_market_order("KRW-BTC", earn * 0.50)
                post_message(myToken, "#cointrade", "BTC 1.5Pro sell : " + str(success4_result))
            elif start_time + datetime.timedelta(hours=13) < now and buy_result != 0 and buy_result * 1.01 < current_price and earn *0.5 >0.0001:
                success5_result = upbit.sell_market_order("KRW-BTC", earn * 0.50)
                post_message(myToken, "#cointrade", "BTC 1Pro sell : " + str(success5_result))
