...
while True:
    ...
    try:
        ...
        start_time = get_start_time("KRW-ADA")+datetime.timedelta(hours=1)  #10:00 부터 시작
            ...
            # 하락세 급락 방지 손절
                ...
                if drop_price > current_price:
                    ...
                    if drop * 0.9 > 3.001:
                        ...
                        post_message(myToken, "#cointrade", "ADA Drop sell : " + str(fail_price))
